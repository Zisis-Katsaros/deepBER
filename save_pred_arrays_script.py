...
x_array, s_dict, a_dict, b_dict, c_dict, d_dict, feature_columns = create_param_prediction_arrays(csv_names, sample_percentage=1.0, sampling_method="lhs", subfolder="s_params")
